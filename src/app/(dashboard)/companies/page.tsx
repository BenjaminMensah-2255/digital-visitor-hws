  ...
  return <>
    ...
    <div className="grid gap-6 xl:grid-cols-[410px_1fr]">
      <section className="panel self-start">
        <div className="panel-header"><div><h2 className="panel-title">Add a company</h2><p className="panel-subtitle">Create the workspace and its first admin</p></div><span className="metric-icon bg-teal-50 text-teal-700"><Icon name="building" className="size-[18px]"/></span></div>
